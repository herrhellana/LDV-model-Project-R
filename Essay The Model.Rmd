...
# cause otherwise it would fuck up the lag function 
...
# pacf(res)
# У НАС ДОХУЯ ЗНАЧИМЫЕ ЛАГИ ХАХАХАХА
# acf говорит об автокорреляции про вариацию. pcf про moving average. 
...
######################
# best model without media: elect demo is sign
...
# best model without media, corr: elect demo is sign
